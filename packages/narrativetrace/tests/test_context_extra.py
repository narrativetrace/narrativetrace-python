...
class TestConcurrencyLifecycle:
    ...
    # Builds and replays a 10,000-deep chain. HANG GUARD, not a timing assertion -- the test only
    # checks replay does not raise and the root resolves, never a duration, so the budget is the
