...
| Arquivos de trace por teste com companheiros `.json` e Mermaid `.mmd` | Gratuito | ligado por padrão, `NARRATIVETRACE_OUTPUT=false` desliga; traces vazios não gravam nada |
