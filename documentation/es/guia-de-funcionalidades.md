<!-- source: documentation/feature-guide.md blob e7c3f0cdc97b | translated: 2026-09-11 | reviewed: - -->
...
| Archivos de traza por prueba con `.json` y compañeros Mermaid `.mmd` | Gratis | activado de forma predeterminada, `NARRATIVETRACE_OUTPUT=false` lo desactiva; las trazas vacías no escriben nada |
